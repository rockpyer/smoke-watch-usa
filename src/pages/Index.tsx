      ...
      <div className="relative z-10 h-[calc(100vh-240px)] md:h-[calc(100vh-88px)] pb-16 md:pb-0">
        <div className="grid grid-cols-1 md:grid-cols-4 h-full gap-4 p-4">
          <div className="md:col-span-3 relative h-full min-h-[400px]">
            {isDataReady ? <SmokeMapLazy onLocationSelect={handleLocationSelect} onCitySearch={handleCitySearch} selectedTime={currentLayer.timestamp} currentLayer={currentLayer} smokeLayers={smokeLayers} /> : <div className="absolute inset-0">
                <MapSkeleton />
              </div>}
          </div>
